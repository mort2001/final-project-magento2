        ...
        initialize: function () {
            ...
            if (this.isBackend) {
                if (this.customScope !== 'billingAddress') {
                    this.value($(this.backendCreateOrderFields.shippingSubdistrictInput).val());
                    if ($(this.backendCreateOrderFields.sameAsBillingInput).is(':checked'))
                        this.disabled(true);
                } else {
                    this.value($(this.backendCreateOrderFields.billingSubdistrictInput).val());
                }
            ...
            if (this.isBackend) {
                if (this.customScope === 'billingAddress') {
                    ...
                    if ($(this.backendCreateOrderFields.sameAsBillingInput).is(':checked')) {
                        ...
                        $(this.uiBackendFields.uiShippingSubdistrictInput).val(this.value());
                    }
