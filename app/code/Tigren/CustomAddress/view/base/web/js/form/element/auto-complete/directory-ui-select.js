...
define([
    ...
    return Abstract.extend({
        defaults: {
            ...
            hoverClass: '_hover',
            rootListSelector: 'ul.action-multiselect-menu-inner._root',
            visibleOptionSelector: 'li.action-multiselect-menu-inner-item:visible',
        ...
        initConfig: function (config) {
            ...
            _.extend(config, result, defaults.presets['single'], defaults.presets[type]);
            this._super();
        ...
        cleanHoveredElement: function () {
            if (this.hoveredElement) {
                $(this.hoveredElement).children(this.actionTargetSelector).removeClass(this.hoverClass);
        ...
        isHovered: function (data) {
            ...
            return elementData && data.value === elementData.value;
        },
        ...
        getSelected: function () {
            ...
            return this.cacheOptions.plain.filter(function (opt) {
                return selected == opt.value;//eslint-disable-line eqeqeq
            });
        },
        ...
        setCaption: function () {
            ...
            if (this.getSelected() && this.getSelected().length && length > 0) {
        ...
        _hoverTo: function (element) {
            ...
            $(element).children(this.actionTargetSelector).addClass(this.hoverClass);
