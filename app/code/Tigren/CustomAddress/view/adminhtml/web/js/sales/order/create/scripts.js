...
define([
    ...
    AdminOrder.prototype = {
        initialize: function (data) {
            ...
            jQuery('#edit_form').on('submitOrder', function () {
        ...
        switchPaymentMethod: function (method) {
            jQuery('#edit_form').off('submitOrder').on('submitOrder', function () {
                jQuery(this).trigger('realOrder');
            });
        ...
        addProduct: function (id) {
            this.loadArea(['items', 'shipping_method', 'totals', 'billing_method'], true,
                { add_product: id, reset_shipping: true });
        },
        ...
        moveQuoteItem: function (id, to) {
            this.loadArea(['sidebar_' + to, 'items', 'shipping_method', 'totals', 'billing_method'],
        ...
        productGridRowInputChange: function (event) {
            ...
            if (element && element.checkboxElement && element.checkboxElement.checked) {
                ...
                } else if (element.name == 'giftmessage' &&
                ...
                if (checkbox) {
                    ...
                    if (confLink.readAttribute('disabled')) {
                        ...
                        productConfigure.setCancelCallback(listType, function () {
                            if (!$(productConfigure.confirmedCurrentId) ||
            ...
            var getPriceFields = function (elms) {
                ...
                for (var i = 0; i < elms.length; i++) {
                    if (elms[i].type == 'select-one' || elms[i].type == 'select-multiple') {
                        ...
                        || ((elms[i].type == 'file' || elms[i].type == 'text' || elms[i].type == 'textarea' ||
                            elms[i].type == 'hidden')
        ...
        sidebarApplyChanges: function (auxiliaryParams) {
            if ($(this.getAreaId('sidebar'))) {
                ...
                data.reset_shipping = true;
                this.loadArea(['sidebar', 'items', 'shipping_method', 'billing_method', 'totals', 'giftmessage'], true,
                    data);
            }
        },
            ...
            if (indicator) {
                ...
                new Ajax.Request(url, {
                    ...
                    onSuccess: function (transport) {
                        ...
                        try {
                            deferred.resolve();
                            if (area == 'data' || area == 'shipping_address' || area == 'billing_address') {
                                location.reload();
                            }
                        ...
                        // jQuery('#order-addresses').trigger('contentUpdated');
        ...
        processCustomerGroupChange: function (
            groupIdHtmlId, message, customerGroupMessage, errorMessage, groupId, action) {
            var groupMessage = '';
            try {
