...
namespace Tigren\CustomAddress\Plugin\Magento\Sales\Block\Adminhtml\Order\Create\Shipping;
...
/**
 * Class Address
 * @package Tigren\CustomAddress\Plugin\Magento\Sales\Block\Adminhtml\Order\Create\Shipping
 */
class Address
{
    /**
    ...
    public function afterToHtml(\Magento\Sales\Block\Adminhtml\Order\Create\Form\Address $subject, $result)
    {
        $addressForm = $subject->getLayout()->createBlock(
            'Tigren\CustomAddress\Block\Adminhtml\Sales\Order\Create\Shipping\CustomAddress'
        );
