 ...
 * Class Tabs
 *
 * @package Tigren\Events\Block\Adminhtml\Category\Edit
 */
class Tabs extends \Magento\Backend\Block\Widget\Tabs
{
    ...
    {
        if (!$this->getData('events_category') instanceof Category) {
        ...
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock(
                    'Tigren\Events\Block\Adminhtml\Category\Edit\Tab\Main'
                )->toHtml()
            ]
        );
