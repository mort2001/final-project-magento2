...
class Data extends AbstractHelper
{
    ...
    const IS_ENABLE_SUCCESS_HEADER = 'ajaxwishlist/general/enabled_success_header';

    const CONTENT_SUCCESS_HEADER = 'ajaxwishlist/general/header_success';
     ...
     * @return bool
     */
    public function isEnabledCustomHeaderAjaxWishList()
    {
        return (bool)$this->scopeConfig->getValue(
     ...
     * @return string|null
     */
    public function getSuccessHeaderAjaxWishList()
    {
        if ($this->isEnabledCustomHeaderAjaxWishList()) {
